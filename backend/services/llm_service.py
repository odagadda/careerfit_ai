...
# 사용 provider: Gemini / Mistral / Ollama
...
def get_provider_and_model(model_name: str) -> tuple[str, str]:
    ...
    - ollama:llama3.2:3b → provider: ollama
    """
...
마감일: {doc.get("metadata", {}).get("deadline", "")}
...
def build_sources(context_docs: list) -> list:
    ...
    for doc in context_docs:
        ...
        sources.append({
            ...
            "deadline_month": metadata.get("deadline_month", ""),
            "is_startup": metadata.get("is_startup", ""),
            "first_saved_date": metadata.get("first_saved_date", ""),
